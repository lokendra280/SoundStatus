class Assets {
  ...
  static const String sound = "$_basePathSvg/sound$_svg";
  ...
  static const String strike = "$_basePathSvg/streak$_svg";
  static const String applogo = "$_basePath/app_icon$_png";
  // onboarding
  static const String onBoardOne = "$_basePathJpg/on1$_jpg";
  static const String onBoardTwo = "$_basePathJpg/on2$_jpg";
  static const String onBoardThree = "$_basePathJpg/on3$_jpg";
}
